...
const SearchDonor = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 pt-40">
      <h2 className="text-2xl font-bold mb-6 text-center text-[#5C0000]">Search Blood Donation Requests</h2>
      ...
      >
        ...
        <button
          type="submit"
          className="md:col-span-3 bg-[#5C0000]  text-white px-4 py-2 rounded hover:bg-red-600"
        >
          Search
        </button>
      </form>
