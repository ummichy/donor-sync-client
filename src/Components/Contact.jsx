...
const Contact = () => {
  return (
    <section className="bg-gradient-to-b from-white to-[#f8f2ea] py-16 px-4 md:px-10">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
        ...
        <motion.div
          ...
          className="bg-white p-8 rounded-xl shadow-2xl border border-[#e9ded0]"
        >
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-[#5C0000]/30 rounded-md focus:outline-none focus:ring-2 focus:ring-[#5C0000] bg-[#fdfaf7]"
              />
            </div>
        ...
        <motion.div
          ...
          className="bg-white p-8 rounded-xl shadow-2xl border border-[#e9ded0] space-y-6"
        >
